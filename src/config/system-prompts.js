...
同一决策点在思考中出现第 2 次不同结论时，立即停止推理，改用 AskUserQuestion 列出 2-4 种可行方案让用户选择，不再在思考中继续推翻。
...
- 不偏离任务目标
- 已验证的内容直接给出结论；能从上下文合理推断的，基于现有信息果断推进，不因轻微不确定而停止
- 无法从上下文合理推断、且实质影响方案/边界/执行结果的决策点，停止反复推翻，列出 2-4 种可行方案抛给用户做决定，不自己在思考中产生幻觉结论
