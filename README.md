...
> API Key 格式为 `sk-xxx`，在管理面板中查看。可用模型列表也可在管理面板的"模型列表"中实时查询。
...
| ---- | -------- | -------- | ------- |
| GitHub Copilot | `openai` | `http://127.0.0.1:3080/copilot` | Copilot 的 `sk-xxx` |
| CodeBuddy OpenAI 模式 | `openai` | `http://127.0.0.1:3080/codebuddy` | CodeBuddy 的 `sk-xxx` |
| CodeBuddy Anthropic 模式 | `anthropic` | `http://127.0.0.1:3080/codebuddy/anthropic/v1` | CodeBuddy 的 `sk-xxx` |
